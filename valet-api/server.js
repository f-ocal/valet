...
var parkOutCoordinates = function(predixResponse) {
  predixResponse.properties.coordinates.split(',').map(function(o){ return o.split(':') });
}
var publicConfig = {
...
var addressLookupFromCoordinates = function(lat, lon) {
    ...
    gmAPI.reverseGeocode(lookup, function(result) {
      console.log(result);
    });
}
console.log('defined functions');
addressLookupFromCoordinates(12,34);
