...
var parkOutCoordinates = function(predixResponse) {
  return predixResponse.properties.coordinates.split(',').map(function(o){ return o.split(':') });
}
var publicConfig = {
...
var parkingCoordinates = getParkingCoordinates();
var [lat, lon] = parkOutCoordinates(parkingCoordinates)[0];
console.log(addressLookupFromCoordinates(lat, lon));
